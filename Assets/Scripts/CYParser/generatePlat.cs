...
public class generatePlat : MonoBehaviour {
	...
	public float x, y;
	public string tex;
	public float size, zidx, level, dia, tri;
	...
	void Start () {
		...
		if (dia == 1) {
			transform.localScale = new Vector3 ((10*size*scale)/Mathf.Sqrt(2), (10*size*scale)/Mathf.Sqrt(2), 1);
		...
		if (dia == 1) {
			side2.transform.rotation = Quaternion.Euler(270, 45, 0);
		}
		...
		if (tri != 0) {
			...
			Mesh mesh2 = side2.GetComponent<MeshFilter>().mesh;
			mesh2.triangles = new int[] {0, 1, 2};
			side2.GetComponent<MeshCollider> ().sharedMesh = mesh2;
			
			switch((int)tri) {
			case 1: 
				transform.rotation = Quaternion.Euler(90, 180, 0);
				side2.transform.rotation = Quaternion.Euler(270, 270, 0);
				break;
			case 2: 
				transform.rotation = Quaternion.Euler(90, 0, 0);
				side2.transform.rotation = Quaternion.Euler(270, 90, 0);
				break;
			case 3: 
				transform.rotation = Quaternion.Euler(90, 90, 0);
				side2.transform.rotation = Quaternion.Euler(270, 180, 0);
				break;
			case 4: 
				transform.rotation = Quaternion.Euler(90, 270, 0);
				side2.transform.rotation = Quaternion.Euler(270, 0, 0);
				break;
			}
		}
